...
var s_1_height = $("#asc").children(".season1").outerHeight() + 14;
var s_2_height = $("#asc").children(".season2").outerHeight() + 14;
var s_3_height = $("#asc").children(".season3").outerHeight() + 14;
var s_4_height = $("#asc").children(".season4").outerHeight() + 14;
var s_5_height = $("#asc").children(".season5").outerHeight() + 14;
var a_or_d = true;
